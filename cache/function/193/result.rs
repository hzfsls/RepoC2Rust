pub fn CmptLzMatchDec(mut decCtx: Ptr<CmptLzDecCtx>, mut pRange: Ptr<u32>, mut pRangeCode: Ptr<u32>, mut pRangeBound: Ptr<u32>, mut dicPosLimit: usize, mut posState: u32) -> u32 {
    ...
    matchLen = CmptLzLenDec(decCtx.cast(), probSlot.cast(), pRange.cast(), pRangeCode.cast(), pRangeBound.cast(), posState.cast());
    matchDist = CmptLzDistDec(decCtx.cast(), probsMatrix.cast(), pRange.cast(), pRangeCode.cast(), pRangeBound.cast(), matchLen.cast());
    ...
    return CmptLzDecByDistAndLen(decCtx.cast(), matchDist.cast(), (matchLen + 2).cast(), dicPosLimit.cast());
}
